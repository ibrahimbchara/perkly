...
function renderResult(cardData) {
  ...
  const features = cardData.matched_features && cardData.matched_features.length
    ? `Matches: ${cardData.matched_features.join(", ")}`
    : "Monetary value prioritized based on your spend.";
  highlight.textContent = features;
...
async function fetchRecommendation() {
  resultContainer.innerHTML = "<p>Crunching the numbers...</p>";
  try {
